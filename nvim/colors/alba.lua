...
vim.api.nvim_set_hl(0, "typescriptClassName", { fg = vim.g.AlbaConstant })
...
vim.api.nvim_set_hl(0, "typescriptInterfaceName", { fg = vim.g.AlbaConstant })
...
vim.api.nvim_set_hl(0, "typescriptTestGlobal", { fg = vim.g.AlbaFunctioType })
